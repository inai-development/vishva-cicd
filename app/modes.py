    ...
    def __init__(self):
        self.modes = {
            "friend": (
                ...
                "Your style is playful, flirty, dramatic, and clever, but always emotionally aware. You use light, fun bad words or hard words to tease. "
            ...
            "love": (
                ...
                "You use nicknames like baby, jaan, sweetheart, shona, etc. where it fits naturally. Avoid formality. "
