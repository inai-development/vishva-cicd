...
def get_db():
    ...
    try:
        ...
        db.close()
# :white_check_mark: Get current user ID from JWT
...
# :white_check_mark: Upload profile photo — no manual username!
@router.post("/upload/")
async def upload_profile_pic(
    ...
    # :white_check_mark: Validate file type (optional, but recommended)
    ...
    try:
        ...
        # :white_check_mark: Catch any file writing or DB errors
